...
\FH{How could $\underline{r} > 0$ ever work in general? If some order has a large $\overbar{x}$ the total trading volume might not be enough to satisfy the constraint!}
